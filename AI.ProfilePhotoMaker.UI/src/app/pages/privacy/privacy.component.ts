      ...
      <div class="legal-container">
        ...
        <div class="legal-card legal-prose">
          ...
          <ul>
            ...
            <li>
              <strong>Photos and outputs:</strong> uploaded photos, generated images, and
              enhancement results.
            </li>
            <li>
          ...
          <h2>5. AI Processing and Biometric Information</h2>
          <p>
          ...
          <p>
            You can manage analytics consent at any time via the Cookie Preferences link in the app.
          </p>
