...
namespace AI.ProfilePhotoMaker.API.Migrations
{
    ...
    [Migration("20260828005356_AddProcessedImageRefinementLink")]
    partial class AddProcessedImageRefinementLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.AbandonedUploadNudgeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("MarketingOptOutAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.MarketingCampaign", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_MarketingCampaigns_CreatedAt");
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.MarketingEmailLog", b =>
                {
                    ...
                    b.Property<string>("PostmarkMessageId")
                        .HasMaxLength(128)
                    ...
                    b.HasIndex("CampaignId")
                        .HasDatabaseName("IX_MarketingEmailLogs_CampaignId");

                    b.HasIndex("PostmarkMessageId")
                        .HasDatabaseName("IX_MarketingEmailLogs_PostmarkMessageId");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_MarketingEmailLogs_Status");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_MarketingEmailLogs_UserId");

                    b.HasIndex("CampaignId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("UX_MarketingEmailLogs_CampaignId_UserId");

                    b.ToTable("MarketingEmailLogs");
                });
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.ProcessedImage", b =>
                {
                    ...
                    b.Property<string>("RawImageStoragePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ReplacesProcessedImageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AI.ProfilePhotoMaker.API.Models.MarketingEmailLog", b =>
                {
                    b.HasOne("AI.ProfilePhotoMaker.API.Models.MarketingCampaign", "Campaign")
                        .WithMany()
