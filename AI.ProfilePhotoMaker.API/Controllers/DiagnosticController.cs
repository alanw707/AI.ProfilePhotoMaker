    ...
    public class DiagnosticController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateTablesWithRawSql()
        {
            ...
            try
            {
                ...
                var sqlCommands = new[]
                {
                    ...
                    // Force populate all 20 styles (clear and repopulate)
                    @"DELETE FROM Styles; 
                      ...
                      ('retro-wave', 'Lifestyle', 'Modern retro synthwave style', 1),
                      ('night-out', 'Lifestyle', 'Sophisticated evening style', 1),
                      ('digital-native', 'Lifestyle', 'Modern tech creator style', 1)"
                };
        ...
        public async Task<IActionResult> PopulateMissingStyles()
        {
            try
            {
                ...
                // Define all 20 styles with rich descriptions and templates
                var stylesToAdd = new[]
                {
        ...
        public async Task<IActionResult> PopulateAllStyles()
        {
            ...
            try
            {
                _logger.LogCritical("🚨 STYLES POPULATION: Populating all 20 styles");
                ...
                // Clear existing styles and insert all 20
                ...
                {
                    success = true,
                    message = "All 20 styles populated successfully",
                    stylesCount = styleCount
                });
            }
            catch (Exception ex)
