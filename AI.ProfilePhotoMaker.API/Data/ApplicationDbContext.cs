...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    private void SeedStyles(ModelBuilder builder)
    {
        var styles = new[]
        {
            ...
            new Style { Id = 19, Name = "fitness", Description = "Fitness professional style", PromptTemplate = "{subject}, fitness professional portrait of {gender} {ethnicity}, athletic style, health and wellness appearance, energetic confident look", NegativePromptTemplate = "blurry, low quality, out of focus, distorted face, bad anatomy, extra fingers, bad hands, sedentary look, unhealthy appearance, low energy, full body shot, watermark, text, waxy skin, plastic skin, airbrushed skin, over-smoothed skin, beauty filter, heavy retouching", IsActive = true, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
