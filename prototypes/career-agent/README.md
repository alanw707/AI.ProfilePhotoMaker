...
The smoke script visits all six pages, tests the profile proposal, location selection, roadmap task, materials download and mobile assistant, captures desktop/mobile review images, checks mobile overflow and reports JavaScript page errors. It uses `CHROME_BIN` if the local Chrome binary differs.
